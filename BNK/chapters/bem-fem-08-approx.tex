...
$A$的强制性(coercive operator)，即存在一个紧凑算子(compact operator)\index{compact operator \dotfill 紧凑算子}$C:X \mapsto X'$，满足Gårding不等式Definition \ref{definitiuon:var-coercive-def}式\eqref{eq:var-coercive-garding-inequality}
\begin{equation*}
