...
式\eqref{eq:log-lin-reset-price-inflation-mc}又被称为New Keynesian Philips Curve (NKPC)\index{New Keynesian Philips Curve (NKPC) \dotfill 新凯恩斯主义菲利普斯曲线}，它反映了中央银行对产出和通货膨胀的trade off。也可以用式\eqref{eq:log-lin-labor-supply}中的output gap $\tilde{X}_t$代替边际成本$mc_{t}$，NKPC改写为
\begin{align}
