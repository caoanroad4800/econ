...
%!TEX root = ../DSGEnotes.tex
\section{变分法}
弱形式边界值问题常常表现为带有算子方程(operator equations)的变分问题。对于变分问题，我们常将其表示为表面积位势和体积位势(surface and volume potentials)的偏微分方程，为了求解方程，就需要求得有界的积分算子方程的解，以建立完备的柯西数列解。本节介绍一些泛函分析的基本知识，进而探讨算子方程解得存在性和唯一性。
