...
对于前者，关键在于构建合适的边界积分式(boundary integral equations)\index{boundary integral equations \dotfill 边界积分等式}以生成完整柯西数列(complete cauchy data)，我们将在第\ref{bvp-integral-operators}节讨论。
