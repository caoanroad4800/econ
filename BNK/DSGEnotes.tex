...
%有限元
\input{./chapters/bem-fem-0901-finele.tex}
\input{./chapters/bem-fem-0902-finele.tex}

\input{./chapters/error.tex}
\part{模型估计}
\label{sec:estimation-dsge}
\input{./chapters/connection.tex}
\input{./chapters/connection-2.tex}
\input{./chapters/connection-appendix.tex}
\input{./chapters/connection-appendix-2.tex}

\part{待分类}
%\input{./chapters/test.tex}
\input{./chapters/mle.tex}
\input{./chapters/qmle.tex}
%\input{./chapters/housing.tex}
\part{附录}
\begin{appendices}
\appendixpage
